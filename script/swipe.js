...
!(function () {
    ...
    function R(e) {
        ...
        if ('touchmove' === c.type) {
            if (
                ((p = [...c.changedTouches].filter((e) => e.identifier === a.touchId)[0]),
    ...
    const ue = [
        ...
        function (e) {
            ...
            function x(e) {
                ...
                let r;
                (r =
                    (y(e) - w(a)[t.isHorizontal() ? 'left' : 'top'] - (null !== d ? d : p / 2)) /
                    (c - p)),
                ...
                r = (e, s) => {
                    ...
                    if (
                        (n || l
                            ...
                            : ((l = r), (n = '0')),
                        (n =
                            n.indexOf('%') >= 0 ? parseInt(n, 10) * s * a + '%' : n * s * a + 'px'),
        ...
        function (e) {
            ...
            const x = () => {
                ...
                E = (e) => {
                    ...
                    !Number.isNaN(r) && r > 0 && void 0 === e && ((i = r), (v = r), (w = r)),
                        (d = i);
    ...
    function ge(e) {
        return (
            void 0 === e && (e = ''), e.replace(/-[a-z]/g, (e) => e.toUpperCase().replace('-', ''))
        );
    }
    const ve = (e) => {
